<script>
    ...
    function show(data) {
        ...
        let url = '{{route('blog.show-count-pair')}}'
            ...
            .then(function (response) {
                ...
                if (queryData) {
                    queryData.forEach(function (row) {
                        ...
                        htmlCode += '<span class="cursor-pointer" >' + row.array + '</span> ';
                        htmlCode += '</div>';
                        htmlCode += '</div>';
                        htmlCode += '</div>';
                        ...
                        htmlCode += '<label>Count(s)</label>';
                        htmlCode += '<p>';
                        htmlCode += '' + row.total_pair + '';
                        htmlCode += '</p>';
                        htmlCode += '<label>Pair(s)</label>';
                        htmlCode += '<p>';
                        htmlCode += '' + row.pairs + '';
                        htmlCode += '</p>';
                        htmlCode += '<div>';
